                                ...
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="text-[10px] text-slate-400 uppercase tracking-wider border-b border-slate-50">
                                            ...
                                            <th className="text-center px-1 py-2 font-semibold" title="Water"><Droplets className="w-3 h-3 mx-auto" /></th>
                                            <th className="text-center px-1 py-2 font-semibold" title="Flood"><Waves className="w-3 h-3 mx-auto" /></th>
                                            <th className="text-center px-1 py-2 font-semibold" title="Power"><Zap className="w-3 h-3 mx-auto" /></th>
                                            <th className="text-center px-1 py-2 font-semibold" title="Sanitation"><ShieldAlert className="w-3 h-3 mx-auto" /></th>
